...
if indovinati == 2:
    ...
    # if match:
    #     if int(numeri_da_generare) > 0 and int(numeri_da_generare) < 100:
    #         numeri_da_generare = int(numeri_da_generare) + 1
    #         break
    # else:
    #     print("Eh dai, o hai esagerato con i numeri (max 100) o hai inserito un valore che non so trattare")
